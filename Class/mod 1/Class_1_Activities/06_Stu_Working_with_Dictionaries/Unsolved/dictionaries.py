...
up_student_loan_information_aj = {"student_name": "Amy Johnston"}
student_loan_information_aj.update(up_student_loan_information_aj)
...
student_loan_information_aj["intrest_rate"] =.035
print(student_loan_information_aj)
...
# @TODO Print the dictionary so that you know your changes are working.
del student_loan_information_aj ['laon_amount']
