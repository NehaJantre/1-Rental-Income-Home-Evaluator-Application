...
for list in portfolio_gain_loss_list:
    sum_list = 0.00
    sum_list += list
    print("Inside loop: $", sum_list)

print("The net gain lost for the period was $", round(sum_list, 2))
...
print(f" average gain and lost per day $ {average_gain_loss_per_day : .2f}")
...
for dict in portfolio_gain_loss_dict:
    sum_dict = 0.00
    sum_dict += dict
    print(sum_dict)
